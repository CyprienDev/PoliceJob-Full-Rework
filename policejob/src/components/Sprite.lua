...
function RenderSprite(TextureDictionary, TextureName, X, Y, Width, Height, Heading, R, G, B, A)
    ...
    DrawSprite(TextureDictionary, TextureName, X + Width * 0.5, Y + Height * 0.5, Width, Height, Heading or 255, tonumber(R) or 23, tonumber(G) or 51, tonumber(B) or 223, tonumber(A) or 200)
end